...
[![Framer Motion](https://img.shields.io/badge/Framer_Motion-12.2-FF0055?logo=framer&logoColor=white&style=flat-square)](https://www.framer.com/motion/)
[![Recharts](https://img.shields.io/badge/Recharts-3.2-22C55E?logo=chartdotjs&logoColor=white&style=flat-square)](https://recharts.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

<br />

<img src="docs/assets/banner.jpg" alt="NASA Space Weather Exploration Hub Banner" width="100%" style="border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.8); border: 1px solid rgba(0, 229, 255, 0.3);" />
...
<div align="center">
  <img src="docs/screenshots/01-hero-dashboard.png" alt="Cosmic Dashboard Screenshot" width="90%" style="border-radius: 12px; border: 1px solid rgba(255, 165, 0, 0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.6);" />
</div>
...
<div align="center">
  <img src="docs/screenshots/02-multilingual-comic-story.png" alt="Multilingual Graphic Novel Screenshot" width="90%" style="border-radius: 12px; border: 1px solid rgba(0, 229, 255, 0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.6);" />
</div>
...
<div align="center">
  <img src="docs/screenshots/03-space-pioneers.png" alt="Space Pioneers Dossier Screenshot" width="90%" style="border-radius: 12px; border: 1px solid rgba(16, 185, 129, 0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.6);" />
</div>
...
<div align="center">
  <img src="docs/screenshots/04-interactive-quiz.png" alt="Interactive Quiz Screenshot" width="90%" style="border-radius: 12px; border: 1px solid rgba(6, 182, 212, 0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.6);" />
</div>
...
<div align="center">
  <img src="docs/screenshots/05-telemetry-analytics.png" alt="Telemetry Analytics Screenshot" width="90%" style="border-radius: 12px; border: 1px solid rgba(245, 158, 11, 0.3); box-shadow: 0 8px 24px rgba(0,0,0,0.6);" />
</div>
